...
#define STRING_CONFIG_H_AUTHOR "(Dewidos, Ender-3 Pro)" // Who made the changes.
...
// Creality Ender-3 Pro
#define DEFAULT_bedKp 101.75
#define DEFAULT_bedKi 19.87
#define DEFAULT_bedKd 347.3
